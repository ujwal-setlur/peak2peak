          ...
          <div className="w-full max-w-[40%] space-y-4 overflow-y-auto">
            <div className="flex w-full flex-col gap-3 bg-white bg-opacity-5 px-5 pb-5">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: postDetails?.description
                    ? strapiRichTextToHtml(postDetails?.description)
                    : '',
                }}
              />
              ...
              <div className="mt-5 w-full">
                ...
                <form className="flex flex-col gap-3" data-comment-form data-post-id={postId}>
                ...
                <ul
                  className="mt-8 max-h-[500px] space-y-3 overflow-y-auto"
                  id={`comments-${postId}`}
                >
